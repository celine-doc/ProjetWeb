...
$today = new DateTime(); // Utiliser la date actuelle
for ($i = 4; $i >= 0; $i--) {
...
<h1>Découvrez les statistiques des villes consultées et des nombres de visites du site</h1>

<h2>Histogramme représentant les statistiques des villes consultées</h2>
<canvas id="visitsChart" width="800" height="400"></canvas>

<h2>Histogramme représentant le nombre de visites du site des 5 derniers jours et total</h2>
