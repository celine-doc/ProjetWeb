...
<main class="main-content">
    ...
    <div class="ville-consultee">
        ...
        if (isset($_COOKIE['ville_consultee'])) {
            ...
            if ($dateConsultation) {
                echo "<div>" . htmlspecialchars($derniereVille) . " - Consultée le " . htmlspecialchars($dateConsultation) . "<br/>";
        ...
        <?php
                    ...
                    echo "Pas de météo disponible pour l'instant.</div>";
                }
            } else {
                echo "<div>" . htmlspecialchars($derniereVille) . " - Date de consultation introuvable.<br/>";
                echo "Pas de météo disponible pour l'instant.</div>";
            }
        } else {
            echo "<div>Aucune ville n'a été consultée pour le moment.</div>";
        }
        ?>
    </div>
</section>
