    ...
    <section>
        ...
        <ul>
            ...
            if (isset($_COOKIE['ville_consultee'])) {
                ...
                if ($dateConsultation) {
                    echo  htmlspecialchars($derniereVille) . " - Consultée le " . htmlspecialchars($dateConsultation) . "<br/>";
                    ...
                    if ($meteoDerniereVille && isset($meteoDerniereVille['list'][0])) {
                        ...
                        echo "Pas de météo disponible pour l'instant";
                    }
                } else {
                    echo  htmlspecialchars($derniereVille) . " - Date de consultation introuvable.<br/>";
                    echo "Pas de météo disponible pour l'instant";
                }
            } else {
                echo "Aucune ville n'a été consultée pour le moment";
            }
            ?>
        </ul>
    </section>
